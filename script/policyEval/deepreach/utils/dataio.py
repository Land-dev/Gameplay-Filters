...
class ReachabilityDataset(Dataset):
    def __init__(
        ...
        self.MPC_integration_method = MPC_integration_method # Only for robust reachability
    ...
    def collect_MPC_io(self, mpc_fn, T, t, style="random"):
        ...
        _, _, MPC_inputs, MPC_values, _ = mpc_fn.get_batch_data(
        ...
        for i in tqdm(range(self.num_MPC_batches - 1)):
            ...
            # t_max=self.tMax
            _, _, MPC_inputs_, MPC_values_, _ = mpc_fn.get_batch_data(
    ...
    def __getitem__(self, idx):
        ...
        elif self.dynamics.loss_type == 'brt_hjivi_inversed':
            return {'model_inputs': model_inputs, 'MPC_inputs': MPC_inputs_}, \
                {'boundary_values': boundary_values,
                    'dirichlet_masks': dirichlet_masks, 'MPC_values': MPC_values_}
...
class RobustReachabilityDataset(ReachabilityDataset):
    ...
    def generate_MPC_dataset(self, T, t, style="random"):
        ...
        if self.add_disturbance_samples:
            ...
            # MPC_inputs = mpc_input_disturbance
            # MPC_values = MPC_values_disturbance
